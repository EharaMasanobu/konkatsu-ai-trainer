...
import { pickRandomHiddenGoal } from "@engine/state/HiddenGoal";
import { StateCalculator } from "@engine/state/StateCalculator";
import { cloneAIState } from "@engine/state/stateUtils";
...
export interface StateUpdateContext {
  ...
  conversationHistory: import("@konkatsu/shared-types").ConversationHistoryMessage[];
