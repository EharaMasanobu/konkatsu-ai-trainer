...
import type { EmotionChangeEntry } from "@engine/emotion/EmotionUpdateRule";
import type { FemaleEmotionState } from "@engine/emotion/FemaleEmotionState";
import { RomanceScoreCalculator } from "@engine/romance/RomanceScoreCalculator";
import {
  createInitialRomanceState,
  type RomanceResult,
  type RomanceSessionState,
  type RomanceTurnLog,
} from "@engine/romance/RomanceState";
import { formatRomanceStateForPrompt } from "@engine/romance/RomancePromptFormatter";
import { resolveRomanceVerdict } from "@engine/constants/romanceVerdict";
...
export class RomanceManager {
  ...
  updateFromEmotion(
    ...
    const update = this.calculator.computeUpdate(
      emotion,
      emotionChanges,
      maleAnalysis,
    );
