import { getMemoryCategoryLabel } from "@/types/Memory";
import type { MemoryDebugSnapshot } from "@/types/messageApi";
          ...
          >
            ...
            <p className="text-violet-600">
              {getMemoryCategoryLabel(
                item.category as import("@/types/Memory").MemoryCategory,
              )}{" "}
              · imp {item.importance}
            </p>
          </li>
