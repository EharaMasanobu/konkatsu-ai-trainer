...
import {
  ...
  RomanceDebugPanel,
  TopicDebugPanel,
  TurnSummaryDebugPanel,
  VoiceRecorder,
} from "@konkatsu/conversation-ui";
...
export function ConversationPage() {
  ...
  const [debugTurnSummary, setDebugTurnSummary] =
    useState<TurnSummaryDebugSnapshot | null>(null);
    ...
    async (trimmed: string) => {
      ...
      try {
        const {
          ...
          debugTurnSummary: nextDebugTurnSummary,
        ...
        if (isDev && nextDebugTurnSummary) {
          setDebugTurnSummary(nextDebugTurnSummary);
        }
